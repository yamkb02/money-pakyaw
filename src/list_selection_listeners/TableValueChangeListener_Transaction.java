...
public class TableValueChangeListener_Transaction implements ListSelectionListener {
    ...
    public TableValueChangeListener_Transaction(JTable table, JButton editButton, JButton deleteButton) {
        this.table = table;
