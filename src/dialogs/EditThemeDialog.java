...
public class EditThemeDialog extends JDialog {
    ...
    // The flags to indicate whether the user clicked the save or delete button or
    // not
    private boolean saved;
    private boolean deleted;

    // The constructor that receives a color string
    public EditThemeDialog(String name, String color) {
        // Call the super constructor with a title and a modal flag
        super((Dialog) null, "Edit Theme", true);
        ...
        deleteButton = new ResponsiveButton("Delete Theme");
        ...
        // Add action listeners to save or delete theme when buttons are clicked
        ...
        // ok mark
        // i will continue the code for the EditThemeDialog class
        ...
        // Set the saved and deleted flags to false initially
        saved = false;
        deleted = false;

        // Set the sliders values according to the color string
        setColor(color);
    }
    ...
    // A method to set the sliders values according to a color string
    private void setColor(String color) {
        // Parse the color string as an integer value using radix 16
        ...
        // Set the sliders values according to the extracted values
    ...
    // A method to get the deleted flag value
    ...
    // A method to delete the theme and close this dialog
